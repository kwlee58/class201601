...
quiz0406$Q1 <- factor(quiz0406$Q1, levels = c("1", "2", "3", "4", "5", "6"), labels = c("새누리당", "더불어민주당", "국민의당", "정의당", "기타정당", "없거나 모르겠다"))
...
pander(round(prop.table(addmargins(table(quiz0406$group, quiz0406$Q3A, exclude = NULL), margin = 1), margin = 1)[4,]*100, digits = 1), caption = "Quota Sampling")
```

### Q3B. Black 만 문항 순서를 바꾸었을 때

##### Black은 Q3A에서 순서만 바꾼 것인데 답이 다르게 나옴. Q3A와 Q3B의 Black만 비교해 볼 것
