...
```{r, data}
class_roll <- read.xlsx("../data/class_roll0302.xlsx", 1, startRow = 2, endRow = 54, colIndex = c(3:7, 9), colClasses=rep("character", 6), stringsAsFactors = FALSE)
str(class_roll)
...
```{r, save}
save.image("../R/red_and_black_160302_data.rda")
```