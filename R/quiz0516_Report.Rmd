...
quiz0516$Q4.2[Red] <- ifelse(quiz0516$Q4[Red] == "가", "확실히", ifelse(quiz0516$Q4[Red] == "나", "확률적으로", NA))
quiz0516$Q4.2[Black] <- ifelse(quiz0516$Q4[Black] == "가", "확실히", ifelse(quiz0516$Q4[Black] == "나", "확률적으로", NA))
quiz0516$Q4.2 <- factor(quiz0516$Q4.2, levels = c("확실히", "확률적으로"))
str(quiz0516)
```
