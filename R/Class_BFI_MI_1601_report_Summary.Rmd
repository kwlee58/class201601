---
title: "Big Five Personality and Multiple Intelligence : 201601"
author: "coop711"
date: "`r Sys.Date()`"
...
```{r, echo = FALSE}
levels(BFI.MI.full$제1순위) <- levels(BFI.MI.full$제3순위)
levels(BFI.MI.full$제2순위) <- levels(BFI.MI.full$제3순위)
